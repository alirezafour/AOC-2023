...
*/
const std::string_view input = R"(Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
...
const std::string_view final_input =
  R"(Game 1: 1 red, 10 blue, 5 green; 11 blue, 6 green; 6 green; 1 green, 1 red, 12 blue; 3 blue; 3 blue, 4 green, 1 red
